...
using RabotaSKod_ASP.Models.ViewModel;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace RabotaSKod_ASP.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ContactsController(ContactsDb contactsDb)
        {
            _context = contactsDb;
        }
        ...
        public async Task<IActionResult> Index(ContactsIndexViewModel model)
        {
            ...
            _context.Contacts.Skip((model.Pager.CurrentPage - 1) * PageSize).Take(PageSize).Select(c => new ContactsViewModel()
            {
                Id = c.Id,
                Email = c.Email,
                Name = c.Name,
        ...
        {
            Contact contact = await _context.Contacts.FindAsync(id);
            _context.Contacts.Remove(contact); await _context.SaveChangesAsync();
